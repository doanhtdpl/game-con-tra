...
//Quay anh
void CSprite::drawRotation(CTexture* image, RECT *RectRS, D3DXVECTOR3 pos, D3DXVECTOR2 scaling, float rotation, D3DCOLOR transcolor, bool isCenter)
{
	//D3DXVECTOR2 scaling = D3DXVECTOR2(1, 1);
...
{
	//D3DXVECTOR2 scaling = D3DXVECTOR2(1, 1);
	this->draw(image, RectRS, pos, scaling, 0.0f, transcolor, isCenter);
}
